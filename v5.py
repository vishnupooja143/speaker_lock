"""
speaker_lock.py - LOW LATENCY OPTIMIZED Speaker Lock
=====================================================
Optimized for speed with:
- Reduced buffer (150ms instead of 500ms)
- VAD early exit for silence
- Fast path for high confidence decisions
...
_EMBEDDING_BUFFER_MS = int(os.getenv("EMBEDDING_BUFFER_MS", "150"))  # 🔥 FAST MODE (150ms instead of 500ms)
...
logger.info(
    ...
    f"BUFFER={_EMBEDDING_BUFFER_MS}ms (FAST MODE), "
...
def _cosine_similarity(a: np.ndarray, b: np.ndarray) -> float:
    # 🔥 OPTIMIZED: Since vectors are normalized, use dot product directly
...
# ======================================================================
# SPEAKER LOCK - CORE CLASS (LOW LATENCY OPTIMIZED)
# ======================================================================
class SpeakerLock:
    def __init__(
        self,
        ...
        # 🔥 NEW: Cached last decision for fast path
    ...
    def process_chunk(self, pcm_bytes: bytes, chunk_ms: float) -> tuple[bool, bool]:
        ...
        # 🔥 OPTIMIZATION 1: VAD early exit for silence
        ...
        # ===== BUFFERED EMBEDDING (REDUCED TO 150ms) =====
        ...
        # 🔥 OPTIMIZATION 2: Fast path for high confidence
...
class SpeakerLockAudioProcessor(rtc.FrameProcessor):
    def __init__(self, debug_record: bool = False, bot_speaking_ref: dict | None = None):
        ...
        logger.info(f"🎤 SpeakerLockAudioProcessor ready (buffer={_EMBEDDING_BUFFER_MS}ms FAST MODE)")
